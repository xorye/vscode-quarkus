...
const extensionName = 'com.redhat.quarkus.jdt.core-0.0.1-SNAPSHOT.jar';
const serverDir = '../quarkus-ls/quarkus.ls/com.redhat.quarkus.ls';
const extensionDir = '../quarkus-ls/quarkus.jdt/com.redhat.quarkus.jdt.core';
...
gulp.task('buildExtension', (done) => {
  cp.execSync(mvnw() + ' clean verify', { cwd: extensionDir, stdio: 'inherit' });
  gulp.src(extensionDir + '/target/' + extensionName)
    .pipe(gulp.dest('./jars'));
  done();
});
